...
我一般每天打开软件后，先点一下“获取论文”→“获取最新”。它会接着上次成功获取的位置继续查，不需要我每天重新设置日期。

获取完成后，我会先切到“本次新增”或“未读”，再选上这段时间最关注的几个细分方向，比如分子生成和分子优化。这样眼前留下的，基本就是今天真正需要看的内容。

接下来就一篇一篇看。单击论文，下面会显示题目、作者和中英文摘要；觉得有意思，就双击进入论文官方网站，有权限的话直接把全文下载下来。读完回到软件，把它标为已读，再点下一篇。

白色的是还没读的，浅绿色的是已经看过的。特别重要的论文我会顺手收藏起来，等有时间再集中精读。我的日常基本就是：获取最新、筛选方向、看摘要、打开原文、标为已读，然后继续下一篇。
