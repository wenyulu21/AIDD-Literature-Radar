...
1. **获取最新文献**：每天打开软件，点击“获取论文”→“获取最新”，软件会从各来源上次成功获取的位置继续检查；
2. **查看本次新增**：获取完成后选择“本次新增”或“未读”，只看今天新进入论文库、尚未阅读的论文；
3. **筛选关注方向**：打开分类筛选，可以同时选择一个或多个 AIDD 细分方向，例如分子生成、分子优化、结构基础设计或性质预测；
4. **快速阅读摘要**：单击论文列表中的一篇论文，在下方详情区查看题目、作者、英文摘要和中文摘要；
5. **打开官方网站**：对感兴趣的论文双击列表项，进入论文官方网站，再根据期刊开放权限或个人/机构订阅下载全文；
6. **记录阅读状态**：回到工具后将论文标为已读；未读论文显示为白色，已读论文显示为浅绿色；
7. **继续下一篇**：点击下一篇未读论文，重复“看摘要→打开原文→标为已读”的流程。特别重要的论文还可以加入收藏，方便以后集中回看。
